...
/**
 * Java class implementing comparator to sort deck of cards
 * 
 * @author SrikarRao
 *
 */
public class CardDeckSorting implements Comparator<Card> {
	...
	public int compare(Card o2, Card o1) {
		...
		if (o1.getSuit().equals("Diamond") || o2.getSuit().equals("Spade")) {
			if (c1 != c2) {
				if (c1 > c2)
					return 1;
				else
